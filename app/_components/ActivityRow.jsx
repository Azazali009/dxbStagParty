...
export default function ActivityRow({ activity }) {
  return (
    <div className="grid grid-cols-9 items-center justify-items-center border border-b-0 border-white/5 px-2 py-2 text-xs duration-300 odd:bg-navyBlue hover:bg-navyBlue">
