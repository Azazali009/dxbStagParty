    ...
    <button
      ...
      className={
        variation === "default"
          ...
          : `${cn("block w-full rounded-full bg-gradient-to-r from-secondary via-[#735d1d] to-secondary px-4 py-3 text-xs font-semibold text-white duration-300 hover:scale-95 hover:bg-gradient-to-br sm:px-8 sm:text-base", className)}`
      }
    >
      {children}
    </button>
