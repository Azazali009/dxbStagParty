...
export default function Button({
  ...
  if (whenToShow.length > 0 && !whenToShow.includes(pathname)) return;
  return (
    <>
      {!href ? (
        <button
          ...
          className={
            variation === "default"
              ...
              : `${cn("block rounded-full border-2 border-matalicGold bg-transparent px-4 py-3 text-center text-sm font-medium capitalize text-matalicGold duration-300 hover:scale-95 hover:bg-gradient-to-l active:translate-y-2 disabled:cursor-not-allowed disabled:bg-gradient-to-r disabled:opacity-40 disabled:hover:scale-100 sm:px-6 sm:text-base", className)}`
          }
        >
          {children}
        </button>
        ...
        <Link
          ...
          className={
            variation === "default"
              ...
              : `${cn("block rounded-full border-2 border-matalicGold bg-transparent px-4 py-2 text-center text-sm font-medium capitalize tracking-wider text-matalicGold duration-300 hover:scale-95 hover:bg-gradient-to-l disabled:cursor-not-allowed disabled:bg-gradient-to-r disabled:opacity-40 disabled:hover:scale-100 sm:px-6 sm:py-3 sm:text-base", className)}`
          }
        >
          {children}
        </Link>
