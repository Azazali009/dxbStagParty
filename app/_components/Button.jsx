    ...
    <button
      ...
      className={
        variation === "default"
          ...
          : `${cn("block w-full rounded-full bg-gradient-to-r from-secondary/80 to-[#604e18]/50 px-4 py-3 text-sm font-semibold capitalize tracking-wider text-softGold duration-300 hover:scale-95 hover:bg-gradient-to-l disabled:cursor-not-allowed disabled:bg-gradient-to-r disabled:opacity-40 disabled:hover:scale-100 sm:px-8 sm:text-base", className)}`
      }
    >
      {children}
    </button>
