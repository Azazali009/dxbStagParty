      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ref={modalRef}
            className={cn(
              "no-scrollbar relative z-50 flex max-h-[90%] min-h-[50%] flex-1 flex-col overflow-y-auto border border-transparent bg-white md:max-w-[70%] md:rounded-2xl dark:border-neutral-800 dark:bg-neutral-950",
              className,
            )}
            initial={{
              opacity: 0,
...
export const ModalFooter = ({ children, className }) => {
  return (
    <div
      className={cn(
        "sticky bottom-0 flex justify-end bg-gray-100 p-4 dark:bg-neutral-900",
        className,
      )}
    >
      {children}
